      ...
      <div class="login_con">
        <div class="regcon">
          <input
            ...
            @blur="funb"
          />
          <p id="redphone" v-show="isNull">{{redphone}}</p>
        </div>
        <div class="regcon">
          <input
            type="text"
            ...
            @blur="fpwd"
          />
          <!-- <img src="../../../static/img/ysf_ic_dialog_close.png" alt="" v-if="ifdel"> -->
          <p id="redphone" v-show="isNull">{{redpwd}}</p>
        </div>
        <div class="regcon test">
          <div>
            <input
              ...
              @blur="yanzheng"
            />
            <p id="redphone" v-show="isNull">{{redinspect}}</p>
          </div>
  ...
  methods: {
    ...
    success() {//登录成功时
      ...
      if(fail){
        ...
        // if()
        this.$axios({
          url:"http://10.35.170.5:8000/user/login/?phonename=" + this.telname+"&password="+this.pwd,
          method:"post" 
        }).then((ok)=>{
          console.log("123");
          this.$router.push({path:'/lmMineAfter',query:{tel:this.telname}})
