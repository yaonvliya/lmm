<template>
	<div class="class1">
		<div class="lm-head" :itemdata="newdata" v-for="(newa,indexa) in arrc" :key="indexa">
		<div class="lm-header">
			<img src="https://pics.lvjs.com.cn/mobile/webapp/release/hotel/pages/hotelDetail/img/head_back_1.png" alt="" class="lm-point">
			<img src="https://pics.lvjs.com.cn/mobile/webapp/release/hotel/pages/hotelDetail/img/head_sc_gray.png" alt="" class="lm-star">
			<img src="https://pics.lvjs.com.cn/mobile/webapp/release/hotel/pages/hotelDetail/img/head_more_gray.png" alt=""class="lm-omit">
		</div>
		<div class="lm-info">
			<p class="lm-name">
				<span @click="back()">{{newa.hotelname}}</span>
			</p>
			<div class="lm-intro">
				<div class="lm-left-img">
					<p class="lm-line1">
						<ul>
							<li>{{newa.hoteltype}}酒店&nbsp;&nbsp;&nbsp;</li>
							<li>{{newa.year}}</li>
						</ul>
						<span>酒店详情></span>
					</p>
					...
					<div class="lm-right">
						<p>
							<i class="lm-score">{{newa.hotelrank}}</i>
							<i>分</i>
						</p>
						<span>好评></span>
					</div>
			...
			<div class="lm-location">
				<div class="lm-left-one">
					...
					<p class="address">{{newa.hotellocaltion}}</p>
		...
		<div v-for="(newb,newindex) in newa.hotel" :key="newindex">
			<div class="lm-guesslike" @click='select()'>
				<span class="lm-guesstag">猜你喜欢</span>
				<img :src="newb.roomtypesimgurl" alt="">
			
				<div class="lm-info-area">
					<p class="name text-home">{{newb.roomtypesname}}
						<i>详情</i>
					</p>
					<p class="attr-1">
						<span>无早</span>
				...
				<div class="lm-price-area">
					<p>
						<i>￥</i>
						<i class="price">{{newb.roomprice}} </i>
					</p>
				</div>
			...
			<ul>
				<li class="lm-bdt-img" v-for="(newc,indexss) in newb.roomtypessmall" :key="indexss">
					<div class="guide">
						<img src="https://pics.lvjs.com.cn//uploads/pc/place2/20190115/images--200n0a0000004jijuD3E8-R-550-412-R20_180_120.jpg"
						 alt="" class="">
						<div class="lm-info-area">
							<p class="name text-home">{{newc.roomtypesnamesname}}
								<i>详情</i>
							</p>
							<p class="attr-1">
								<!-- 	<span>无早</span>
						...
						<div class="lm-price-area">
							<p>
								...
								<img src="../assets/img/img/p.png" alt="">
							</p>
						</div>
					</div>
					<ul></ul>
				...
				<li>
					<div class="guide">
						<img src="https://pics.lvjs.com.cn//uploads/pc/place2/20190115/images--200n0a0000004jijuD3E8-R-550-412-R20_180_120.jpg"
						 alt="" class="">
						<div class="lm-info-area">
							<p class="name text-home">(豪华花园景观双...
								<i>详情</i>
							</p>
							<p class="attr-1">
								<span>无早</span>
...
<script>
	...
	export default {
		...
		created:function(){
			fetch("http://localhost:3000/hotellist")
			.then((res)=>{
				return res.json();
			})
			.then((req)=>{
				return this.arrb=req;
			})
		},
		computed: {
			newdata() {
...
<style scoped>
	...
	.lm-header {
		...
		overflow: hidden;
		background: url(https://pics.lvjs.com.cn//uploads/pc/place2/20181117/images-2002050000000mb6q88DD-R-550-412-R20_480_320.jpg) no-repeat;
	}
