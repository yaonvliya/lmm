<template>
	<div class="class1">
		<div class="lm-comment">
			<p class="lm-com-head">
				<span class="rate">4.7分</span>
				<span class="num">218条评论></span>
			</p>
			<ul class="score">
				<li>服务5.0分</li>
				<li>卫生5.0分</li>
			...
			<p class="name">p****9</p>
			<p class="star">
				<img src="../assets/img/img/star.png" alt="">
				<i>2019-08-07 16:05:20发表</i>
			</p>
			<p class="commtext">总体不错。酒店人不太多，还有各项优惠。如果带孩子去还是比较方便的。</p>
		</div>
		<div class="lm-policy">
			<img src="../assets/img/img/pocity.png" alt="">
			<p class="lm-commtitle">酒店政策</p>
			<div class="lm-Htime">
				<img src="../assets/img/img/dia.png" alt="">
				<p>最早到店时间</p>
				<p>15:00m</p>
			</div>
			<div class="lm-Htime pet">
				<img src="../assets/img/img/dia.png" alt="">
				<p>宠物</p>
				<p>不可携带宠物</p>
			</div>
			<div class="lm-Htime last">
				<img src="../assets/img/img/dia.png" alt="">
				<p>最晚离店时间</p>
				<p>11:00</p>
			</div>
			<div class="lm-Htime forg">
				<img src="../assets/img/img/dia.png" alt="">
				<p>外宾</p>
				<p>可接待外宾</p>
			</div>
			<div class="lm-special-word">
				<img src="../assets/img/img/dia.png" />
				<p>特殊证策</p>
				<div class="lm-add_height">
					<p class="special_content">
						根据《上海市公共场所控制吸烟条例》，
						从2017年3月1日起，酒店不能安排吸烟房，
						并禁止在酒店室内区域吸烟。
						2019.7.1起旅游住宿业将不再主动提供
						牙刷、梳子、浴擦、剃须刀、指甲锉、鞋擦这些一次性日用品，
						详询酒店前台。
					</p>
				</div>
			...
			<div class="lm-other">
				...
				<p class="other_cont">
					...
					<span>
						<span>1.为了您人身、财产的安全，
							请您避免在公开场合暴露贵重物品及大量现金。
							外出时需时刻看管好首饰、相机等随身物品。</span>
					</span>
					<span>
						<span>2.游泳、漂流、潜水、浮潜、冲浪、快艇、
							滑雪、滑冰、热气球、高空跳伞、滑翔伞、动力伞、
							攀岩、登山、骑马、驾驶、温泉、冲沙、索道、
							蹦极等活动项目，均存在危险。
							参与前请根据自身条件，
							充分参考当地相关部门及其它专业机构的相关公告和建议后量力而行。
							请您在预订前阅读驴妈妈为您整理各项高风险活动的</span>
						<a href="http://m.lvmama.com/precautions">《安全须知》</a>
					</span>
				</p>
				<p class="special-more">查看更多</p>
			</div>
		</div>
	</div>
	</div>
