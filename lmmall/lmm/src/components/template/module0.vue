<template>
<div>
	<div id="module0" class="module-main module mshow0 product7" v-for="(items,indexs) in module0" :key="indexs">
       	<img class="img-title csmc" :src="items.headurl0">
		<div class="tab-main type_COMMON_STYLE_5" data-type="COMMON_STYLE_5">
			<div class="tab-list">
				<ul class="list">
					<li style="display: block;" v-for="(item,index) in items.modu0" :key="index">
						<a class="addStatistics addSensorsTrackProduct" href="#">
						<div class="load-img ztImgLoaded">
							<img :src="item.moduurl">
						</div>
							<div class="cot">
...
<script>
	export default{
		...
		created: function() {
				fetch("http://localhost:3000/module0")
					.then((res) => {
						return res.json();
					})
					.then((req) => {
						this.module0 = req;
						console.log(this.module0);
						return this.module0;
					})
			},
	}
...
<style scoped>
.img-title{width: 100%;height: 98px;margin-top: 22px;}
